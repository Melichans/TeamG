...
public class UserDAO {
    ...
    // This field is not ideal, as it can be shared across threads.
    // A better approach is to get the connection within each method.
    ...
    // Default constructor for cases where connection is managed per method
    public UserDAO() {}
    ...
    public UserBean getUserByCredentials(String companyCode, String username) throws SQLException {
        ...
        String sql = "SELECT u.user_id, u.account_id, u.company_id, c.company_code, c.company_name, " +
                     ...
                     "u.push_notifications_enabled, u.language " +
                     "FROM user u " +
    ...
    public void updateUserSettings(int userId, boolean notificationsEnabled, String language) throws SQLException {
        ...
        // Using DBConnection here for safety, as the passed-in connection might be closed.
